...
def create_batches(image_path, train_val_test_ratio):
    ...
    for classname in legend:
        ...
        for i in range(int(len(legend[classname])*train_val_test_ratio[0]), int(len(legend[classname])*(train_val_test_ratio[0]+train_val_test_ratio[1]))):    # training data
        ...
        for i in range(int(len(legend[classname])*(train_val_test_ratio[0]+train_val_test_ratio[1])), len(legend[classname])):    # training data
        ...
        return image_data_generator(train_path, val_path, test_path, target_size=(150, 150), classes=classnames, batch_size=32)
